...
public interface IProgressConstants {
	...
	/**
	 * Stores whether or not the option in dialogs to put jobs into background is
	 * hidden.
	 */
	public static final QualifiedName HIDE_RUN_IN_BACKGROUND = new QualifiedName(PROPERTY_PREFIX,
			"progressDialogHideRunInBackground"); //$NON-NLS-1$
}
