...
public class JobsViewPreferenceDialog extends ViewSettingsDialog {
	...
	private BooleanFieldEditor hideRunInBackground;
	...
	protected Control createDialogArea(Composite parent) {
		...
		hideRunInBackground = new BooleanFieldEditor(IProgressConstants.HIDE_RUN_IN_BACKGROUND.toString(),
				ProgressMessages.JobsViewPreferenceDialog_HideRunInBackground, editArea);
		hideRunInBackground.setPreferenceName(IProgressConstants.HIDE_RUN_IN_BACKGROUND.toString());
		hideRunInBackground.setPreferenceStore(preferenceStore);
		hideRunInBackground.load();
	...
	protected void performDefaults() {
		...
		hideRunInBackground.loadDefault();
	}
}
